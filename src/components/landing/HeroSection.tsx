        ...
        <div className="col-span-1 lg:col-span-7 space-y-8 text-center lg:text-left">
          ...
          >
            <button
              ...
              className="px-6 py-4 bg-amber-400 hover:bg-amber-300 text-slate-900 font-bold rounded-xl text-sm sm:text-base transition-all duration-300 shadow-[0_0_20px_rgba(251,191,36,0.3)] hover:shadow-[0_0_30px_rgba(251,191,36,0.5)] flex items-center justify-center gap-2"
            >
            ...
            <button
              onClick={onInfoClick}
              className="px-6 py-4 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl text-sm sm:text-base transition-all duration-300 flex items-center justify-center gap-2"
            >
